...
namespace LogicaDatos
{
    public class ItinerarioVuelos
    {
        ...
        public ItinerarioDeVuelos[] consultarEscalas(int iditinerario)
        {
            string query = "select idvuelo,iditinerario,razonsocial,ciudadorigen.idciudad idciudadorigen, ciudadorigen.nomciudad ciudadorigen,ciudaddestino.idciudad idciudaddestino, "
                          + "ciudaddestino.nomciudad ciudaddestino,fechasalida, horasalida,fechallegada,horallegada,cantsillas,preciovuelo "
                          + "from vuelos inner join aerolinea on aerolinea.idaerolinea = vuelos.idaerolinea "
                          + "inner join ciudad ciudadorigen on ciudadorigen.idciudad = vuelos.idciudadorigen "
                          + "inner join ciudad ciudaddestino on ciudaddestino.idciudad = vuelos.idciudaddestino "
                          + "where iditinerario= "+iditinerario+" and indestadoiti = 3";
